...
<tr><td bgcolor='#6A71A3'>
<table width="100%" cellspacing=1 cellpadding=3 align=center>
<tr><td class='t' colspan=2 bgcolor='#6A71A3'><font color="#FFFFFF">$lang[code_8]</font></td></tr>
<tr>
<td class='t' colspan=2>$lang[code_5]</td>
</tr>
<tr>
<td class='t' colspan=2>
	<input type="checkbox" name="yh[]" value='1' checked />$lang[code_6]
	<input type="checkbox" name="yh[]" value='2' />$lang[code_7]
	<input type="checkbox" name="yh[]" value='3' />$lang[code_10]
</td>
</tr>
<tr><td class='t' colspan=2>$lang[code_9]</td></tr>
</table></td></tr></table>
<br>
<!--
EOT;
